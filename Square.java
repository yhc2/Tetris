...
public class Square {
	...
	/**
	 * Set the new row for this Square
	 */
	public void setRow(int newRow) {
		this.row = newRow;
	}
	/**
	 * Set the new column for this Square
	 */
	...
	public void rotate(Square square) {
		int newRow = getRotatedRow(square);
		int newCol = getRotatedCol(square);
		row = newRow;
		col = newCol;
	}
	...
	/**
	 * return the new row after rotating
	 */
	public int getRotatedRow(Square square) {
		int centreRow = square.getRow();
        int centreCol = square.getCol();
        int colToBeMoved = this.getCol();
        int rotatedRow = centreRow + (colToBeMoved - centreCol);
        return rotatedRow;
	}
	
	/**
	 * return the new column after rotating
	 */
 
	public int getRotatedCol(Square square) {
		int centreRow = square.getRow();
        int centreCol = square.getCol();
        int rowToBeMoved = this.getRow();
        int rotatedCol = centreCol + (centreRow - rowToBeMoved);
        return rotatedCol;
	}
